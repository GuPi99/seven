	...
	<body>
					...
					<form class="layui-form" id="zyc_search" style="display: inline-block;">
						...
						<li>
							<div class="layui-form-item">
								<select name="pcState" lay-filter="caidan" lay-search>
									<option value="0">待审批项目</option>
									<option value="1">待主管审批项目</option>
									<option value="2">待经理审批项目</option>
									<option value="3">审批通过</option>
									<option value="4">完结项目</option>
									<option value="-1">部门驳回项目</option>
									<option value="-2">主管驳回项目</option>
									<option value="-3">经理驳回项目</option>
									<option value="-4">作废项目</option>
		...
		<script>
			var SCOPE = {
					...
					'select_url': '${pageContext.request.contextPath}/sevenProject/viewSelect',                  //数据查看方法接口
				}
			//关闭所有弹框，并重新加载当前页面
			function cloae(){
				layer.closeAll();
