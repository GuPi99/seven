...
<html>
	...
	<body>
					...
					<form class="layui-form" id="zyc_search" style="display: inline-block;">
						...
						<li>
							<div class="layui-form-item">
								<input type="text" name="lDatetime" placeholder="请选择日期" autocomplete="off" class="layui-input date">
							</div>
						</li>
						<!-- 页面内容：头部——查询框或下拉框 结束 -->
		...
		<!-- 页面操作js文件 -->
		<script src="${pageContext.request.contextPath}/static/js/log/load.js"></script>
		<script>
			var SCOPE = {
				'table_url': '${pageContext.request.contextPath}/sevenLog/getSevenLogList', //列表数据查询来源（json文件或接口地址，可自行修改）；模糊搜索查询接口地址（menu指当前控制器，selects指查询方法，可自行修改）
			}
		</script>
	</body>
</html>
