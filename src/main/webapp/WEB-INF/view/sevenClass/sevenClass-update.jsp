...
<html>
	...
	<body>
			...
			<form class="layui-form" lay-filter="formTest">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" name="cName" placeholder="请输入类型名称" class="layui-input">
					</div>
					<div class="zyc_verify" data-name="cName"></div>
				</div>
				
				<div class="layui-form-item">
					<label class="layui-form-label"><span>*</span>备注 : </label>
					<div class="layui-input-block">
						<textarea name="cDescribe" placeholder="请输入类型描述" class="layui-textarea"></textarea>
					</div>
					<div class="zyc_verify" data-name="cDescribe"></div>
				</div>
		...
		<script>
			var SCOPE = {
				'operate': '${pageContext.request.contextPath}/sevenClass/updateSevenClass',//数据提交接口
				'value': '${pageContext.request.contextPath}/sevenClass/selectSevenClassById',//编辑时，获取单一数据接口，用以展示编辑数据
			}
