	...
	<body>
		...
		<div id="app">
			...
			<form class="layui-form" lay-filter="formTest">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text"  name="mSort" placeholder="请输入排序序号" class="layui-input">
					</div>
				</div>
				<input type="hidden"  name="mState" class="layui-input">
		...
		<script>
			var SCOPE = {
				...
				'operate': '${pageContext.request.contextPath}/sevenMenus/updateSevenMenus',//数据提交接口
				'value': '${pageContext.request.contextPath}/sevenMenus/selectSevenMenusById',//编辑时，获取单一数据接口，用以展示编辑数据
			}
					...
					$.ajax({
						...
						success: function(result) {
							if (result.status == 0) {
								...
								$("select[name=mMid]").val(datas.mMid);//下拉框赋值
