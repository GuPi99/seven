	...
	<body>
		...
		<script>
			var SCOPE = {
				...
				'know': '${pageContext.request.contextPath}/sevenProjectBill/directorKnow', 
				'operate': '${pageContext.request.contextPath}/sevenProjectBill/addSevenProjectBill', //数据提交接口
				'value': '${pageContext.request.contextPath}/sevenProject/selectSevenProjectById'
			}
