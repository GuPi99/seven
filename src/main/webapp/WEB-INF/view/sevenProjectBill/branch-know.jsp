...
<html>
	...
	<body>
			...
			<form class="layui-form" lay-filter="formTest">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="radio" name="pbState" value="1" title="通过" checked>
						<input type="radio" name="pbState" value="-1" title="驳回">
					</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<textarea name="pbBranch" placeholder="请输入批语" class="layui-textarea"></textarea>
					</div>
					<div class="zyc_verify" data-name="pb_branch"></div>
				</div>
		...
		<script>
			var SCOPE = {
				'operate': '${pageContext.request.contextPath}/sevenProjectBill/addBranch', //数据提交接口
			}
