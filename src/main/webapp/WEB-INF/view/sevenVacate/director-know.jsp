...
<html>
	...
	<body>
			...
			<form class="layui-form" lay-filter="formTest">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="radio" name="vSate" value="2" title="通过" checked>
						<input type="radio" name="vSate" value="-2" title="驳回">
					</div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<textarea name="vDirector" placeholder="请输入批语" class="layui-textarea"></textarea>
					</div>
					<div class="zyc_verify" data-name="v_director"></div>
				</div>
		...
		<script>
			var SCOPE = {
				'operate': '${pageContext.request.contextPath}/sevenVacate/addDirector', //数据提交接口
			}
