...
<html>
	...
	<body>
		...
		<script>
			var SCOPE = {
				'table_url': '${pageContext.request.contextPath}/sevenVacate/getSevenVacatetList', //列表数据查询来源（json文件或接口地址，可自行修改）；模糊搜索查询接口地址（menu指当前控制器，selects指查询方法，可自行修改）
				'know': '${pageContext.request.contextPath}/sevenVacate/directorKnow', 
