...
<html>
	...
	<body>
			...
			<form class="layui-form" lay-filter="formTest">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="radio" name="vSate" value="1" title="通过" checked>
						<input type="radio" name="vSate" value="-1" title="驳回">
					</div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<textarea name="vBranch" placeholder="请输入批语" class="layui-textarea"></textarea>
					</div>
					<div class="zyc_verify" data-name="v_branch"></div>
				</div>
		...
		<script>
			var SCOPE = {
				'operate': '${pageContext.request.contextPath}/sevenVacate/addBranch', //数据提交接口
			}
