...
<html>
	...
	<body>
		...
		<div id="app">
			...
			<form class="layui-form" lay-filter="formTest">
				...
				<div class="layui-form-item">
					<label class="layui-form-label"><span>*</span>计划回收日期 : </label>
					<div class="layui-input-block">
						<input type="text" name="pfpPlanDate" placeholder="请输入计划回收日期" class="layui-input date">
					</div>
					<div class="zyc_verify" data-name="pfp_plan_date"></div>
				</div>
				
				<div class="layui-form-item">
					<label class="layui-form-label"><span>*</span>计划回收金额 : </label>
					<div class="layui-input-block">
						<input type="text" name="pfpPlanSum" placeholder="请输入计划回收金额" class="layui-input">
					</div>
		...
		<script>
			var SCOPE = {
				'operate': '${pageContext.request.contextPath}/sevenProjectFundPlan/addSevenProjectFundPlan',//数据提交接口
			}
