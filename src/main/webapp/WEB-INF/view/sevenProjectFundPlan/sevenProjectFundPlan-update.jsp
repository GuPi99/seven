...
<html>
	...
	<body>
		...
		<div id="app">
			...
			<form class="layui-form" lay-filter="formTest">
				...
				<div class="layui-form-item">
					<label class="layui-form-label"><span>*</span>实际回收日期 : </label>
					<div class="layui-input-block">
						<input type="text" name="pfpActualDate" placeholder="请输入实际回收日期" class="layui-input date">
					</div>
					<div class="zyc_verify" data-name="pfp_actual_date"></div>
				</div>
				
				<div class="layui-form-item">
					<label class="layui-form-label"><span>*</span>实际回收金额 : </label>
					<div class="layui-input-block">
						<input type="text" name="pfpActualSum" placeholder="请输入实际回收金额" class="layui-input">
					</div>
					<div class="zyc_verify" data-name="pfp_actual_sum"></div>
				</div>
		...
		<script>
			var SCOPE = {
				'operate': '${pageContext.request.contextPath}/sevenProjectFundPlan/updateSevenProjectFundPlan',//数据提交接口
				'value': '${pageContext.request.contextPath}/sevenProjectFundPlan/selectSevenProjectFundPlan',//编辑时，获取单一数据接口，用以展示编辑数据
			}
