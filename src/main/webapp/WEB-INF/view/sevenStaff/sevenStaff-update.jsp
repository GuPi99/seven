...
<html>
	...
	<body>
		...
		<script>
			var SCOPE = {
				'operate': '${pageContext.request.contextPath}/sevenStaff/updateSevenStaff', //数据提交接口
				'value': '${pageContext.request.contextPath}/sevenStaff/selectSevenStaffById', //编辑时，获取单一数据接口，用以展示编辑数据
			}
						...
						url: SCOPE.value,
					 	...
					 	success: function(result) {
					 		if (result.status == 0) {
					 			...
					 			$("select[name=sSex]").val(datas.sSex);//下拉框赋值
