...
<html>
	...
	<body>
			...
			<form class="layui-form" lay-filter="formTest">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" name="mItems" placeholder="请输入项目名称" class="layui-input date">
					</div>
					<div class="zyc_verify" data-name="m_items"></div>
				</div>
				
				<div class="layui-form-item">
					<label class="layui-form-label"><span>*</span>金额  : </label>
					<div class="layui-input-block">
						<input type="number" name="mFigure" placeholder="请输入金额" class="layui-input date">
					</div>
					<div class="zyc_verify" data-name="m_figure"></div>
				</div>
				
				<div class="layui-form-item">
					<label class="layui-form-label"><span>*</span>描述  : </label>
					<div class="layui-input-block">
						<textarea class="layui-textarea" name="mDescribe" placeholder="请输入描述"></textarea>
					</div>
		...
		<script>
			var SCOPE = {
				'operate': '${pageContext.request.contextPath}/sevenMelt/addSevenMelt',//数据提交接口
			}
