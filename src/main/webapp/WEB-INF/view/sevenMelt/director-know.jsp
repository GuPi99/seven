...
<html>
	...
	<body>
			...
			<form class="layui-form" lay-filter="formTest">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="radio" name="mState" value="2" title="通过" checked>
						<input type="radio" name="mState" value="-2" title="驳回">
					</div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<textarea name="mDirector" placeholder="请输入批语" class="layui-textarea"></textarea>
					</div>
		...
		<script>
			var SCOPE = {
				'operate': '${pageContext.request.contextPath}/sevenMelt/addDirector', //数据提交接口
			}
