	...
	<body>
		...
		<script>
			var SCOPE = {
				...
				'operate': '${pageContext.request.contextPath}/sevenRole/updateSevenRole',//数据提交接口
				'value': '${pageContext.request.contextPath}/sevenRole/selectSevenRoleById',//编辑时，获取单一数据接口，用以展示编辑数据
			}
