	...
	<body>
		...
		<div id="app">
			...
			<form class="layui-form" lay-filter="formTest">
				...
				<div class="layui-form-item">
					...
					<div class="zyc_verify" data-name="t_fid"></div>
				</div>
				
				<div class="layui-form-item">
					<label class="layui-form-label"><span>*</span>平台名称 : </label>
					<div class="layui-input-block">
						<input type="text" name="tName" placeholder="请输入平台名称" class="layui-input">
					</div>
					<div class="zyc_verify" data-name="t_name"></div>
				</div>
				
				<div class="layui-form-item">
					<label class="layui-form-label"><span>*</span>平台地址 : </label>
					<div class="layui-input-block">
						<input type="text" name="tUrl" placeholder="请输入平台地址" class="layui-input">
					</div>
					<div class="zyc_verify" data-name="t_url"></div>
				</div>
				
				<div class="layui-form-item">
					<label class="layui-form-label"><span>*</span>注册邮箱 : </label>
					<div class="layui-input-block">
						<input type="text" name="tEmail" placeholder="请输入注册邮箱" class="layui-input">
					</div>
					<div class="zyc_verify" data-name="t_email"></div>
				</div>
				
				<div class="layui-form-item">
					<label class="layui-form-label"><span>*</span>平台密码 : </label>
					<div class="layui-input-block">
						<input type="text" name="tPaw" placeholder="请输入平台密码" class="layui-input">
					</div>
					<div class="zyc_verify" data-name="t_paw"></div>
				</div>
		...
		<script>
			var SCOPE = {
					...
					'operate': '${pageContext.request.contextPath}/sevenTerrace/updateSevenTerrace',//数据提交接口
				'value': '${pageContext.request.contextPath}/sevenTerrace/selectSevenTerraceById',//编辑时，获取单一数据接口，用以展示编辑数据
			}
					...
					$.ajax({
						...
						success: function(result) {
							if (result.status == 0) {
								...
								$("select[name=tFid]").val(datas.tFid);//下拉框赋值
								form.render(); //下拉框重新渲染
							} else {
								var msg = result.msg;
								layer.msg(msg);
