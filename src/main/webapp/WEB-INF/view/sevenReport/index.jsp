...
<html>
	...
	<body>
		...
		<script type="text/html" id="zyc_btn">
			{{#  if(d.rIndicate == null){ }}
				<a class="layui-btn layui-btn-xs" title="指示" href="#" lay-event="direction">指示</a>
			{{#  } }}
		</script>
		<!-- 列表：操作按钮绑定——结束 -->
		<!-- jquery文件 -->
		...
		<script>
			var SCOPE = {
				...
				'operate': '${pageContext.request.contextPath}/sevenReport/addIndicate',                //数据操作方法，如需增加多个方法，可在load.js中进行修改
			}
		</script>
	</body>
</html>
