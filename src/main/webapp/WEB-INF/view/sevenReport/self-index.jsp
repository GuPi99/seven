...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/static/css/visit/index.css"/>
	</head>
	<body id="app">
		<!-- 页面内容——开始 -->
		<div id="app">
		...
		<script>
			layui.use(['laydate','form','table','layer'], function(){
				...
				form.on('submit(add)',function(data){
					layer.open({
						type: 2,
						content:'${pageContext.request.contextPath}/sevenReport/toAdd',
						area : ['1200px', '800px'],
						maxmin : true,
						title : '添加报告'
					})
				...
				table.on('tool(test)', function(obj){
					var data = obj.data;
					var url='${pageContext.request.contextPath}/sevenReport/selectSevenReport?id='+data.id;
					if(obj.event === 'detail'){
						layer.open({
							type: 2,
							content:url,
			    ...
			    data.rDate='';
			    data.rTitle='';
				var url='${pageContext.request.contextPath}/sevenReport/getSelfReportList';
