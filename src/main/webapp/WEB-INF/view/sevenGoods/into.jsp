...
<html>
	...
	<body>
			...
			<ul class="layui-timeline">
				<li class="layui-timeline-item">
					...
					<div class="layui-timeline-content layui-text">
						...
						<p>请<a download="产品" href="${pageContext.request.contextPath}/static/excel/goods.xlsx">下载</a>对应格式Excel，进行批量导入</p>
					</div>
				</li>
				<li class="layui-timeline-item">
					<i class="layui-icon layui-timeline-axis">&#xe63f;</i>
		...
		<script>
			var SCOPE = {
				'operate': '${pageContext.request.contextPath}/sevenGoods/batchAddition',
			}
