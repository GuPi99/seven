...
<html>
	...
	<body>
		...
		<div id="app">
			...
			<form class="layui-form" lay-filter="formTest">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" name="pDate" placeholder="请输入日期" class="layui-input date">
					</div>
					<div class="zyc_verify" data-name="p_date"></div>
				</div>
				
				<div class="layui-form-item">
					<label class="layui-form-label"><span>*</span>上午/下午 : </label>
					<div class="layui-input-block">
						<select name="pIs" lay-search>
							<option value="0">上午</option>
							<option value="1">下午</option>
						</select>
					</div>
					<div class="zyc_verify" data-name="p_is"></div>
				</div>
				
				<div class="layui-form-item">
					<label class="layui-form-label"><span>*</span>交通工具 : </label>
					<div class="layui-input-block">
						<input type="text" name="pVehicle" placeholder="请输入交通工具" class="layui-input">
					</div>
					<div class="zyc_verify" data-name="p_vehicle"></div>
				</div>
				
				<div class="layui-form-item">
					<label class="layui-form-label"><span>*</span>拜访目的 : </label>
					<div class="layui-input-block">
						<input type="text" name="pGoal" placeholder="请输入拜访目的" class="layui-input">
					</div>
					<div class="zyc_verify" data-name="p_goal"></div>
				</div>
		...
		<script>
			var SCOPE = {
				'selects': '${pageContext.request.contextPath}/sevenFirm/selectAll',//角色数据获取
				'operate': '${pageContext.request.contextPath}/sevenPlan/addSevenPlan',//编辑时，获取单一数据接口，用以展示编辑数据
			}
	      		...
	      		success: function(result) {
	       			...
	       			if (result.status == 0) {
						...
						$('.zyc_verify').each(function() {
							...
							$(this).html(errorMsg != undefined ? '*' + errorMsg : '').css('cssText', 'color: red !important');
						});
					} else { //其它错误，弹框提示
						//解除提交按钮禁止点击
						that.removeClass('layui-btn-disabled');
