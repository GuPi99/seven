...
<!-- 页面内容——开始 -->
		...
		<script>
			layui.use(['laydate','form','table','layer','element'], function(){
				...
				var url='${pageContext.request.contextPath}/sevenDailyPlan/getSelfDayList';
				var data=new Object();
			    data.dpWhere='';
			    data.dpDate='';
				search(url,data);
				...
				form.on('submit(add)',function(data){
					$("#open",parent.document).attr('src','${pageContext.request.contextPath}/sevenDailyPlan/toDayAdd');
					return false;
				})
