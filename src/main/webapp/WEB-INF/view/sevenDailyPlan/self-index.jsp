		...
		<div class="planBlock">
			...
			<div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
				<ul class="layui-tab-title">
					<li id="${pageContext.request.contextPath}/sevenDailyPlan/selfDay" class="layui-this">日计划</li>
					<li id="${pageContext.request.contextPath}/sevenDailyPlan/selfWeek">周计划</li>
					<li id="${pageContext.request.contextPath}/sevenDailyPlan/selfMonth">月计划</li>
				</ul>
				<div class="layui-tab-content">
					<div class="layui-tab-item layui-show" style="height: 500px">
						<iframe style="height:500px !important" id="open" class="planIf" name="" width="100%" height="100%" frameborder="0" src="${pageContext.request.contextPath}/sevenDailyPlan/selfDay"></iframe>
					</div>
				</div>
			</div>
		</div>
