			...
			<form class="layui-form" lay-filter="formTest">
				...
				<div class="layui-form-item" style="width: 640px">
					<label class="layui-form-label">
						<div class="titleBg"><span>*</span>计划类型 : </div>
					</label>
					<div class="layui-input-block" style="width: 500px">
						 <select name="dpWhere" lay-verify="dpEid" lay-filter="test">
				...
				<div class="layui-form-item" style="width: 640px">
					...
					<div class="layui-input-block rili" style="width: 500px">
						...
						<input type="text" name="dpDate" class="layui-input" id="test1">
					</div>
				</div>
				<div class="layui-form-item">
					<textarea id="content" lay-verify="content" name="dpWork" ></textarea>
				</div>
			</form>
			<!-- 表单——结束 -->
		</div>
		...
		<script>
			layui.use(['laydate','form','layedit'], function(){
				...
				form.on('submit(formDemo)', function(data){
					...
					var str=new Object();
					str.dpWork=layedit.getContent(index);
					str.dpType=1;
					str.dpDate=data.field.dpDate;
					str.dpWhere=data.field.dpWhere;
					var url='${pageContext.request.contextPath}/sevenDailyPlan/addSevenDailyPlan'
					add(url,str);
					return false;
				})
				form.on('select(test)', function(data){
					$("#open",parent.document).attr('src','${pageContext.request.contextPath}/sevenEvection/toAdd');
					if(data.value==2){
						url='${pageContext.request.contextPath}/sevenEvection/toAdd'
						layer.open({
							type: 2,
							content:url,
							area : ['1200px', '800px'],
