...
<html>
	...
	<body>
		...
		<div id="app">
			...
			<form class="layui-form" lay-filter="formTest">
				...
				<div class="layui-form-item">
					<!-- *表示必填，非必填项可将span标签删除 -->
					<label class="layui-form-label"><span>*</span>职位名称 : </label>
					<!-- 输入框或下拉框 -->
				...
				<div class="layui-form-item">
					<!-- *表示必填，非必填项可将span标签删除 -->
					<label class="layui-form-label"><span>*</span>职位职责: </label>
					<!-- 输入框或下拉框 -->
					<div class="layui-input-block">
						<input type="text" name="mDesc" placeholder="请输入职位职责" class="layui-input">
					</div>
					<!-- 验证信息展示处，data-name对应验证数据 -->
					<div class="zyc_verify" data-name="m_name"></div>
				</div>
		...
		<script>
			var SCOPE = {
					'operate': '${pageContext.request.contextPath}/sevenMessage/addSevenMessage',//数据提交接口
			}
