...
<html>
	...
	<body>
		...
		<div id="app">
			...
			<form class="layui-form" lay-filter="formTest" enctype="multipart/form-data">
				...
				<div class="layui-form-item">
					<label class="layui-form-label"><span>*</span>文件名称 : </label>
					<div class="layui-input-block">
						<input type="text" name="pfName" id="pfName" placeholder="请输入文件名称" class="layui-input">
					</div>
					<div class="zyc_verify" data-name="pf_name"></div>
				</div>
				
				<div class="layui-form-item">
					<label class="layui-form-label"><span>*</span>选择文件 : </label>
					<div class="layui-input-block">
						<input type="file" id="file" name="file" placeholder="请选择文件" class="layui-input">
					</div>
		...
		<script>
			var SCOPE = {
				'operate': '${pageContext.request.contextPath}/sevenProjectFile/addSevenProjectFile',//数据提交接口
			}
