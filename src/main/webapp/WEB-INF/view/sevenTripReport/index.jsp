...
<html>
	...
	<body>
			...
			<div class="zyc_content">
				...
				<form class="layui-form" lay-filter="formTest">
					...
					<div class="layui-form-item">
						<label class="layui-form-label"><span>*</span>出发日期 : </label>
						<div class="layui-input-block">
							<input type="text" name="trDate" placeholder="请选择出发日期" class="layui-input date">
						</div>
						<div class="zyc_verify" data-name="tr_date"></div>
					</div>
					
					<div class="layui-form-item">
						<label class="layui-form-label"><span>*</span>返程日期 : </label>
						<div class="layui-input-block">
							<input type="text" name="trEnd" placeholder="请选择返程日期" class="layui-input date">
						</div>
						<div class="zyc_verify" data-name="tr_end"></div>
					</div>
					
					<div class="layui-form-item">
						<textarea name="trContent" id="demo"></textarea>
					</div>
				<!-- 提交按钮——开始 -->
					<div class="layui-form-item">
						<div class="layui-input-block">
		...
		<!-- 页面操作js文件 -->
		<script src="${pageContext.request.contextPath}/static/js/business/load.js"></script>
		<script>
			var SCOPE = {
				'value': '${pageContext.request.contextPath}/sevenTripReport/selectTripReport', //列表数据查询来源（json文件或接口地址，可自行修改）；模糊搜索查询接口地址（menu指当前控制器，selects指查询方法，可自行修改）
				'operate': '${pageContext.request.contextPath}/sevenTripReport/addSevenTripReport'
			}
