...
<html>
	...
	<body>
			...
			<form class="layui-form" lay-filter="formTest">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="radio" name="applicationState" value="3" title="通过" checked>
						<input type="radio" name="applicationState" value="-3" title="驳回">
					</div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<textarea name="dManager" placeholder="请输入批语" class="layui-textarea"></textarea>
					</div>
					<div class="zyc_verify" data-name="m_manager"></div>
				</div>
		...
		<script>
			var SCOPE = {
				'operate': '${pageContext.request.contextPath}/sevenDelivery/addManger', //数据提交接口
			}
