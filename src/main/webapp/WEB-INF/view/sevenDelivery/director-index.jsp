...
<html>
	...
	<body>
					...
					<form class="layui-form" id="zyc_search" style="display: inline-block;">
						...
						<li>
							<div class="layui-form-item">
								<select name="dSid" lay-filter="caidan" lay-search>
						...
						<li>
							<div class="layui-form-item">
								<select name="applicationState" lay-filter="caidan" lay-search>
									...
									<option value="2">通过审批</option>
									<option value="-2">驳回审批</option>
								</select>
							</div>
						</li>
						<li>
		...
		<script>
			var SCOPE = {
				'table_url': '${pageContext.request.contextPath}/sevenDelivery/getSevenDeliveryList', //列表数据查询来源（json文件或接口地址，可自行修改）；模糊搜索查询接口地址（menu指当前控制器，selects指查询方法，可自行修改）
				'know': '${pageContext.request.contextPath}/sevenDelivery/directorKnow', 
				'selects': '${pageContext.request.contextPath}/sevenStaff/selectAll',
			}
			//关闭所有弹框，并重新加载当前页面
			function cloae(){
				layer.closeAll();
