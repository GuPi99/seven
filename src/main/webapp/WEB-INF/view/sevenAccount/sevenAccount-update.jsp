...
<html>
	...
	<body>
			...
			<form class="layui-form" lay-filter="formTest">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" name="aAccount" placeholder="请输入账户名称" class="layui-input">
					</div>
		...
		<script>
			var SCOPE = {
				'selects': '${pageContext.request.contextPath}/sevenRole/selectAll',//角色数据获取
				'operate': '${pageContext.request.contextPath}/sevenAccount/updateSevenAccount',//数据提交接口
				'value': '${pageContext.request.contextPath}/sevenAccount/selectSevenAccountById',//编辑时，获取单一数据接口，用以展示编辑数据
			}
					...
					$.ajax({
						...
						success: function(result) {
							if (result.status == 0) {
								...
								$("select[name=aRid]").val(datas.aRid);//下拉框赋值
								$("select[name=aSid]").val(datas.aSid);//下拉框赋值
