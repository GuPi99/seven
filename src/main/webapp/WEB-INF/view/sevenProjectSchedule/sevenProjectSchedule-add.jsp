...
<html>
	...
	<body>
		...
		<div id="app">
			...
			<form class="layui-form" lay-filter="formTest" enctype="multipart/form-data">
				<div class="layui-form-item">
					<label class="layui-form-label"><span>*</span>进度描述 : </label>
					<div class="layui-input-block">
						<textarea rows="4" class="layui-textarea" id="psContent" name="psContent" placeholder="请输入进度描述"></textarea>
					</div>
					<div class="zyc_verify" data-name="ps_content"></div>
				</div>
				
				<div class="layui-form-item">
					<label class="layui-form-label"><span>*</span>选择文件 : </label>
					<div class="layui-input-block">
						<input type="file" name="file" id="file" placeholder="请选择文件" class="layui-input">
					</div>
					<div class="zyc_verify" data-name="file"></div>
				</div>
		...
		<script>
			var SCOPE = {
				'operate': '${pageContext.request.contextPath}/sevenProjectSchedule/addSevenProjectSchedule',//数据提交接口
			}
			layui.use(['form', 'laydate'], function() {
				...
				form.on('submit(formDemo)', function(data) {
					...
					formData.append("psPid", id);
					formData.append("psContent", $("#psContent").val());
