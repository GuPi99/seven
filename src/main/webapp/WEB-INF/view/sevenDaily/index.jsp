		...
		<div class="planBlock">
			<div class="topBtn">
				<div class="addicon">
					...
					<div class="left"> 工作日志</div>
				</div>
			</div>
			<div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
				<ul class="layui-tab-title">
					<li id="${pageContext.request.contextPath}/sevenDaily/AllDay" class="layui-this">日报</li>
					<li id="${pageContext.request.contextPath}/sevenDaily/AllWeek">周报</li>
					<li id="${pageContext.request.contextPath}/sevenDaily/AllMonth">月报</li>
				</ul>
				<div class="layui-tab-content">
					<div class="layui-tab-item layui-show" style="height: 500px">
						<iframe style="height:500px !important" id="open" class="planIf" name="" width="100%" height="100%" frameborder="0" src="${pageContext.request.contextPath}/sevenDaily/AllDay"></iframe>
					</div>
				</div>
			</div>
		</div>
