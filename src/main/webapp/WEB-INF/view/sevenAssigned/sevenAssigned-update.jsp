	...
	<body>
		...
		<div id="app">
			...
			<form class="layui-form" lay-filter="formTest">
				...
				<div class="layui-form-item">
					...
					<div class="zyc_verify" data-name="aWork"></div>
				</div>
		...
		<script>
			var SCOPE = {
				...
				'operate': '${pageContext.request.contextPath}/sevenAssigned/updateSevenAssigned',//数据提交接口
				'value': '${pageContext.request.contextPath}/sevenAssigned/selectSevenAssignedById',//编辑时，获取单一数据接口，用以展示编辑数据
			}
