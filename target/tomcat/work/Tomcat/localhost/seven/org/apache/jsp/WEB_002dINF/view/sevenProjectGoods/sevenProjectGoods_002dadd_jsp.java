 ...
 * Generated at: 2020-02-29 12:53:08 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.WEB_002dINF.view.sevenProjectGoods;

import javax.servlet.*;
import javax.servlet.http.*;
import javax.servlet.jsp.*;

public final class sevenProjectGoods_002dadd_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t<title>项目需求产品管理</title>\r\n");
      ...
      out.write("\t\t\t\t\t<label class=\"layui-form-label\"><span>*</span>产品类型 : </label>\r\n");
      out.write("\t\t\t\t\t<div class=\"layui-input-block\">\r\n");
      out.write("\t\t\t\t\t\t<select name=\"pgCid\">\r\n");
      out.write("\t\t\t\t\t\t\t<option value=\"\"></option>\r\n");
      out.write("\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"zyc_verify\" data-name=\"pg_pid\"></div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t<div class=\"layui-form-item\">\r\n");
      out.write("\t\t\t\t\t<label class=\"layui-form-label\"><span>*</span>系统产品 : </label>\r\n");
      out.write("\t\t\t\t\t<div class=\"layui-input-block\">\r\n");
      out.write("\t\t\t\t\t\t<select name=\"pgGid\">\r\n");
      out.write("\t\t\t\t\t\t\t<option value=\"\"></option>\r\n");
      out.write("\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"zyc_verify\" data-name=\"pg_gid\"></div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t<div class=\"layui-form-item\">\r\n");
      out.write("\t\t\t\t\t<label class=\"layui-form-label\"><span>*</span>自定义名称 : </label>\r\n");
      out.write("\t\t\t\t\t<div class=\"layui-input-block\">\r\n");
      out.write("\t\t\t\t\t\t<input type=\"text\" name=\"psName\" placeholder=\"请输入自定义名称\" class=\"layui-input\">\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"zyc_verify\" data-name=\"ps_name\"></div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t<div class=\"layui-form-item\">\r\n");
      out.write("\t\t\t\t\t<label class=\"layui-form-label\"><span>*</span>自定义型号 : </label>\r\n");
      out.write("\t\t\t\t\t<div class=\"layui-input-block\">\r\n");
      out.write("\t\t\t\t\t\t<input type=\"text\" name=\"pgModel\" placeholder=\"请输入自定义型号\" class=\"layui-input\">\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"zyc_verify\" data-name=\"pg_model\"></div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t<div class=\"layui-form-item\">\r\n");
      out.write("\t\t\t\t\t<label class=\"layui-form-label\"><span>*</span>需求数量 : </label>\r\n");
      out.write("\t\t\t\t\t<div class=\"layui-input-block\">\r\n");
      out.write("\t\t\t\t\t\t<input type=\"number\" name=\"pgNum\" placeholder=\"请输入需求数量\" class=\"layui-input\">\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"zyc_verify\" data-name=\"pg_num\"></div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t<div class=\"layui-form-item\">\r\n");
      out.write("\t\t\t\t\t<label class=\"layui-form-label\">备注 : </label>\r\n");
      out.write("\t\t\t\t\t<div class=\"layui-input-block\">\r\n");
      out.write("\t\t\t\t\t\t<textarea name=\"pgNote\" placeholder=\"请输入备注\" class=\"layui-textarea\"></textarea>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"zyc_verify\" data-name=\"pg_note\"></div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t<!-- 提交按钮——开始 -->\r\n");
      out.write("\t\t\t\t<div class=\"layui-form-item\">\r\n");
      ...
      out.write("\t\t\t\t'selects': '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/sevenGoods/selectAllCG',//类型下拉框数据获取\r\n");
      out.write("\t\t\t\t'operate': '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/sevenProjectGoods/addSevenProjectGoods',//数据提交接口\r\n");
      out.write("\t\t\t\t'value': 'value',//编辑时，获取单一数据接口，用以展示编辑数据\r\n");
      out.write("\t\t\t}\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\tvar datas = result.type;\r\n");
      out.write("\t\t\t\t\t\t\t\tvar li = [];\r\n");
      out.write("\t\t\t\t\t\t\t\t$(datas).each(function(i){\r\n");
      out.write("\t\t\t\t\t\t\t\t\tli.push('<option value=\"'+datas[i].id+'\">'+datas[i].cName+'</option>');\r\n");
      out.write("\t\t\t\t\t\t\t\t})\r\n");
      out.write("\t\t\t\t\t\t\t\tvar lis = li.join(\"\");\r\n");
      out.write("\t\t\t\t\t\t\t\t$('select[name=pgCid]').html(lis);\r\n");
      out.write("\t\t\t\t\t\t\t\tform.render('select');\r\n");
      out.write("\t\t\t\t\t\t\t\tgoods($('select[name=pgPid]').val());\r\n");
      out.write("\t\t\t\t\t\t\t\tform.on('select(pgPid)', function(data){\r\n");
      out.write("\t\t\t\t\t\t\t\t\tgoods(data.value);\r\n");
      out.write("\t\t\t\t\t\t\t\t});      \r\n");
      out.write("\t\t\t\t\t\t\t} else {\r\n");
      ...
      out.write("\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t})\r\n");
      out.write("\t\t\t\tfunction goods(id){\r\n");
      out.write("\t\t\t\t\tvar postData = {};\r\n");
      out.write("\t\t\t\t\tpostData['id'] = id;\r\n");
      out.write("\t\t\t\t\t$.ajax({\r\n");
      out.write("\t\t\t\t\t\ttype: \"get\",\r\n");
      out.write("\t\t\t\t\t\turl: SCOPE.selects,\r\n");
      out.write("\t\t\t\t\t\tdata: postData,\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\tvar li = [];\r\n");
      out.write("\t\t\t\t\t\t\t\t$(datas).each(function(i){\r\n");
      out.write("\t\t\t\t\t\t\t\t\tli.push('<option value=\"'+datas[i].id+'\">'+datas[i].gName+'</option>');\r\n");
      out.write("\t\t\t\t\t\t\t\t})\r\n");
      out.write("\t\t\t\t\t\t\t\tvar lis = li.join(\"\");\r\n");
      out.write("\t\t\t\t\t\t\t\t$('select[name=pgGid]').html(lis);\r\n");
      out.write("\t\t\t\t\t\t\t\tform.render('select');\r\n");
      out.write("\t\t\t\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t\t\t\tvar msg = result.msg;\r\n");
      out.write("\t\t\t\t\t\t\t\tlayer.msg(msg);\r\n");
