 ...
 * Generated at: 2020-03-04 01:28:40 UTC
...
public final class sevenProject_002dadd_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t<button type=\"button\" class=\"layui-btn layui-btn-danger\" id=\"zyc_button\">作废</button>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</form>\r\n");
      out.write("\t\t\t<!-- 表单——结束 -->\r\n");
      ...
      out.write("\t\t\t\t'operate': '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/sevenProject/addSevenProject', //数据提交接口\r\n");
      out.write("\t\t\t}\r\n");
      ...
      out.write("\t\t\t\t\tvar stste = $.getUrlParam('state'); //获取state\r\n");
      out.write("\t\t\t\t\tif (stste > 0) {\r\n");
      ...
      out.write("\t\t\t\t\t\tform.render('select');\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t$('.zyc_iframe').attr('src', $('.layui-tab-title>.layui-this').data('url') + '?id=' + id + '&state=' + stste);\r\n");
      out.write("\t\t\t\t\telement.on('tab(demo)', function(data) {\r\n");
      out.write("\t\t\t\t\t\t$('.zyc_iframe').attr('src', $(this).data('url') + '?id=' + id + '&state=' + stste);\r\n");
      out.write("\t\t\t\t\t});\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t$('.zyc_iframe').attr('src', $('.layui-tab-title>.layui-this').data('url') + '?id=' + result.data + '&state=0');\r\n");
      out.write("\t\t\t\t\t\t\t\telement.on('tab(demo)', function(data) {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t$('.zyc_iframe').attr('src', $(this).data('url') + '?id=' + result.data + '&state=0');\r\n");
      out.write("\t\t\t\t\t\t\t\t});\r\n");
