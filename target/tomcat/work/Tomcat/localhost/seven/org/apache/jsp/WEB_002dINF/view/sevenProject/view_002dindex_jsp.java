 ...
 * Generated at: 2020-03-03 14:43:43 UTC
...
public final class view_002dindex_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t<select name=\"pcState\" lay-filter=\"caidan\" lay-search>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"0\">待审批项目</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"1\">待主管审批项目</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"2\">待经理审批项目</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"3\">审批通过</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"4\">完结项目</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"-1\">部门驳回项目</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"-2\">主管驳回项目</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"-3\">经理驳回项目</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"-4\">作废项目</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"\">全部项目</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t\t<li>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"layui-form-item\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<select name=\"pFid\" lay-filter=\"caidan\" lay-search>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"\">全部企业</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t\t<li>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"layui-form-item\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"text\" name=\"pDate\" placeholder=\"请选择拟定日期\" autocomplete=\"off\" class=\"layui-input date\">\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</li>\r\n");
      ...
      out.write("\t\t<script src=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/static/js/project/load.js\"></script>\r\n");
      out.write("\t\t<script>\r\n");
      out.write("\t\t\tvar SCOPE = {\r\n");
      out.write("\t\t\t\t\t'table_url': '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/sevenProject/getSevenProjectList', //列表数据查询来源（json文件或接口地址，可自行修改）；模糊搜索查询接口地址（menu指当前控制器，selects指查询方法，可自行修改）\r\n");
      out.write("\t\t\t\t\t'selects': '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/sevenFirm/selectAll',                 //模糊搜索下拉框数据方法接口\r\n");
      out.write("\t\t\t\t\t'select_url': '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/sevenProject/viewSelect',                  //数据查看方法接口\r\n");
      out.write("\t\t\t\t}\r\n");
