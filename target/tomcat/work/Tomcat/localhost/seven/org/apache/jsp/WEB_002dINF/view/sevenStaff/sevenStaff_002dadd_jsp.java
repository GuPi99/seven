 ...
 * Generated at: 2020-04-23 08:40:51 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.WEB_002dINF.view.sevenStaff;

import javax.servlet.*;
import javax.servlet.http.*;
import javax.servlet.jsp.*;

public final class sevenStaff_002dadd_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t<input type=\"text\" name=\"sName\" placeholder=\"请输入员工姓名\" class=\"layui-input\">\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"zyc_verify\" data-name=\"s_name\"></div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"layui-form-item\">\r\n");
      out.write("\t\t\t\t\t\t<label class=\"layui-form-label\"><span>*</span>联系电话 : </label>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"layui-input-block\">\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"tel\" name=\"sPhone\" placeholder=\"请输入员工联系电话\" class=\"layui-input\">\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"zyc_verify\" data-name=\"s_phone\"></div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"layui-form-item\">\r\n");
      out.write("\t\t\t\t\t\t<label class=\"layui-form-label\"><span>*</span>办公电话 : </label>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"layui-input-block\">\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" name=\"officePhone\" placeholder=\"请输入办公电话 \" class=\"layui-input\">\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"zyc_verify\" data-name=\"s_address\"></div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"layui-form-item\">\r\n");
      out.write("\t\t\t\t\t\t<label class=\"layui-form-label\"><span>*</span>职责描述 : </label>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"layui-input-block\">\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" name=\"sDuty\" placeholder=\"请输入职责描述\" class=\"layui-input\">\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"zyc_verify\" data-name=\"s_address\"></div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"layui-form-item\">\r\n");
      out.write("\t\t\t\t\t\t<label class=\"layui-form-label\"><span>*</span>联系邮箱 : </label>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"layui-input-block\">\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"email\" name=\"sEmail\" placeholder=\"请输入员工联系邮箱\" class=\"layui-input\">\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"zyc_verify\" data-name=\"s_email\"></div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"layui-form-item\">\r\n");
      out.write("\t\t\t\t\t\t<label class=\"layui-form-label\"><span>*</span>传真 : </label>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"layui-input-block\">\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" name=\"faxNum\" placeholder=\"请输入传真\" class=\"layui-input\">\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"zyc_verify\" data-name=\"s_address\"></div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t<div class=\"layui-input-block\">\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" name=\"sDateBirth\" placeholder=\"请选择出生年月\" class=\"layui-input date\">\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"zyc_verify\" data-name=\"s_date_birth\"></div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"layui-form-item\">\r\n");
      out.write("\t\t\t\t\t\t<label class=\"layui-form-label\"><span>*</span>现住址 : </label>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"layui-input-block\">\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" name=\"sAddress\" placeholder=\"请输入员工现住址\" class=\"layui-input\">\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"zyc_verify\" data-name=\"s_address\"></div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"layui-form-item\">\r\n");
      out.write("\t\t\t\t\t\t<label class=\"layui-form-label\"><span>*</span>职称 : </label>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"layui-input-block\">\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" name=\"sTitle\" placeholder=\"请输入员工职称\" class=\"layui-input\">\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"zyc_verify\" data-name=\"s_address\"></div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/sevenOffice/index\" class=\"layui-this\">职位</li>\r\n");
      out.write("\t\t\t\t\t\t\t<!--<li data-url=\"../loca/index.html\">定位</li>-->\r\n");
      out.write("\t\t\t\t\t\t\t<!-- <li data-url=\"../items/index.html\">项目</li> -->\r\n");
      out.write("\t\t\t\t\t\t\t<li data-url=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/sevenDaily/trend\">动向</li>\r\n");
      out.write("\t\t\t\t\t\t</ul>\r\n");
      ...
      out.write("\t\t\t\t\t\t<button type=\"button\" class=\"layui-btn\" id=\"zyc_edit\">编辑</button>\r\n");
      out.write("\t\t\t\t\t\t<button lay-filter=\"formDemo\" lay-submit class=\"layui-btn\" id=\"zyc_refer\">立即提交</button>\r\n");
      out.write("\t\t\t\t\t\t<button type=\"reset\" class=\"layui-btn layui-btn-primary\" id=\"zyc_reset\">重置</button>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</form>\r\n");
      out.write("\t\t\t<!-- 表单——结束 -->\r\n");
      ...
      out.write("\t\t<script>\r\n");
      out.write("\t\t\tvar SCOPE = {\r\n");
      out.write("\t\t\t\t'selects': '../../json/menuselect.json', //上级菜单下拉框数据获取\r\n");
      out.write("\t\t\t\t'operate': '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/sevenStaff/addSevenStaff', //数据提交接口\r\n");
      out.write("\t\t\t}\r\n");
      ...
      out.write("\t\t\t\t\t\t$('#zyc_reset').css('display', 'none');\r\n");
      ...
      out.write("\t\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t\tvar ids = $('input[name=id]').val();\r\n");
      out.write("\t\t\t\t\t\t$('#zyc_edit').css('display', 'none');\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t$('.zyc_iframe').attr('src', $('.layui-tab-title>.layui-this').data('url') + '?id=' + ids);\r\n");
      out.write("\t\t\t\t\telement.on('tab(demo)', function(data) {\r\n");
      out.write("\t\t\t\t\t\t$('.zyc_iframe').attr('src', $(this).data('url') + '?id=' + id);\r\n");
      out.write("\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t\t$('#zyc_edit').click(function() {\r\n");
      out.write("\t\t\t\t\t\t$('input').removeAttr(\"disabled\");\r\n");
      out.write("\t\t\t\t\t\t$('select').removeAttr(\"disabled\");\r\n");
      out.write("\t\t\t\t\t\t$('#zyc_edit').css('display', 'none');\r\n");
      out.write("\t\t\t\t\t\t$('#zyc_refer').css('display', 'inline-block');\r\n");
      out.write("\t\t\t\t\t\t$('#zyc_reset').css('display', 'inline-block');\r\n");
      out.write("\t\t\t\t\t\tform.render('select');\r\n");
      out.write("\t\t\t\t\t})\r\n");
      out.write("\t\t\t\t})\r\n");
      out.write("\t\t\t\t//表单提交---提交表单后返回id主键\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t$('input[name=id]').val(result.data);\r\n");
