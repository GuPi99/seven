 ...
 * Generated at: 2020-04-14 09:41:32 UTC
...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t<select name=\"applicationState\" lay-filter=\"caidan\" lay-search>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"\">全部</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"0\">待审批</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"1\">待主管审批</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"2\">待经理审批</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"3\">审批通过</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"-1\">部门驳回项目</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"-2\">主管驳回项目</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"-3\">经理驳回项目</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t\t<li>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"layui-form-item\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"text\" name=\"projectNum\" placeholder=\"请输入项目编号\" autocomplete=\"off\" class=\"layui-input\">\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t\t<li>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"layui-form-item\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"text\" name=\"projectName\" placeholder=\"请输入项目名称\" autocomplete=\"off\" class=\"layui-input\">\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t\t<li>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"layui-form-item\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"text\" name=\"applicationDate\" placeholder=\"请选择申请日期\" autocomplete=\"off\" class=\"layui-input date\">\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</li>\r\n");
      ...
      out.write("\t\t\t\t\t<li><button id=\"zyc_add\" class=\"layui-btn layui-btn-normal\"><i class=\"iconfont iconxinzeng\"></i>申请发货</button></li>\r\n");
      out.write("\t\t\t\t</ul>\r\n");
      ...
      out.write("\t\t\t<a class=\"layui-btn layui-btn-xs\" title=\"查看\" href=\"#\" lay-event=\"view\">查看</a>\r\n");
      out.write("\t\t</script>\r\n");
      ...
      out.write("\t\t<script src=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/static/js/delivery/load.js\"></script>\r\n");
      out.write("\t\t<script>\r\n");
      out.write("\t\t\tvar SCOPE = {\r\n");
      out.write("\t\t\t\t'table_url': '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/sevenDelivery/getSelfDeliveryList', //列表数据查询来源（json文件或接口地址，可自行修改）；模糊搜索查询接口地址（menu指当前控制器，selects指查询方法，可自行修改）\r\n");
      out.write("\t\t\t\t'add_url': '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/sevenDelivery/toAdd',\t\t\t\t\t  //新增页面跳转路径（menu指当前控制器，add指页面或控制器方法，可自行修改）\r\n");
      out.write("\t\t\t\t'view_url': '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/sevenDelivery/toView',\r\n");
      out.write("\t\t\t}\r\n");
