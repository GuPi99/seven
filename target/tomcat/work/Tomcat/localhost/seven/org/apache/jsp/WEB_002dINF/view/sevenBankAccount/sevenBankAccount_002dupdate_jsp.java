 ...
 * Generated at: 2020-02-19 00:15:55 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.WEB_002dINF.view.sevenBankAccount;

import javax.servlet.*;
import javax.servlet.http.*;
import javax.servlet.jsp.*;

public final class sevenBankAccount_002dupdate_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t<label class=\"layui-form-label\"><span>*</span>企业 : </label>\r\n");
      out.write("\t\t\t\t\t<div class=\"layui-input-block\">\r\n");
      out.write("\t\t\t\t\t\t<select name=\"baFid\">\r\n");
      out.write("\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"zyc_verify\" data-name=\"ba_fid\"></div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t<div class=\"layui-form-item\">\r\n");
      out.write("\t\t\t\t\t<label class=\"layui-form-label\"><span>*</span>银行 : </label>\r\n");
      out.write("\t\t\t\t\t<div class=\"layui-input-block\">\r\n");
      out.write("\t\t\t\t\t\t<select name=\"baBid\">\r\n");
      out.write("\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"zyc_verify\" data-name=\"ba_bid\"></div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t<div class=\"layui-form-item\">\r\n");
      out.write("\t\t\t\t\t<label class=\"layui-form-label\"><span>*</span>账户 : </label>\r\n");
      out.write("\t\t\t\t\t<div class=\"layui-input-block\">\r\n");
      out.write("\t\t\t\t\t\t<input type=\"text\" name=\"baAccount\" placeholder=\"请输入账户号码\" class=\"layui-input\">\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"zyc_verify\" data-name=\"ba_account\"></div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t'selects': '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/sevenBankAccount/selectAllBankAndFirm', //下拉框数据方法接口\r\n");
      out.write("\t\t\t\t'operate': '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/sevenBankAccount/updateSevenBankAccount',//数据提交接口\r\n");
      out.write("\t\t\t\t'value': '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/sevenBankAccount/selectSevenBankAccountById',//编辑时，获取单一数据接口，用以展示编辑数据\r\n");
      out.write("\t\t\t}\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\tvar datas = result.firm;\r\n");
      out.write("\t\t\t\t\t\t\t\tvar li = [];\r\n");
      out.write("\t\t\t\t\t\t\t\t$(datas).each(function(i){\r\n");
      out.write("\t\t\t\t\t\t\t\t\tli.push('<option value=\"'+datas[i].id+'\">'+datas[i].fName+'</option>');\r\n");
      out.write("\t\t\t\t\t\t\t\t})\r\n");
      out.write("\t\t\t\t\t\t\t\tvar lis = li.join(\"\");\r\n");
      out.write("\t\t\t\t\t\t\t\t$('select[name=baFid]').html(lis);\r\n");
      out.write("\t\t\t\t\t\t\t\tvar banks = result.bank;\r\n");
      out.write("\t\t\t\t\t\t\t\tvar lin = [];\r\n");
      out.write("\t\t\t\t\t\t\t\t$(banks).each(function(i){\r\n");
      out.write("\t\t\t\t\t\t\t\t\tlin.push('<option value=\"'+banks[i].id+'\">'+banks[i].bName+'</option>');\r\n");
      out.write("\t\t\t\t\t\t\t\t})\r\n");
      out.write("\t\t\t\t\t\t\t\tvar lins = lin.join(\"\");\r\n");
      out.write("\t\t\t\t\t\t\t\t$('select[name=baBid]').html(lins);\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t$(\"select[name=baFid]\").val(datas.baFid);//下拉框赋值\r\n");
      out.write("\t\t\t\t\t\t\t\t$(\"select[name=baBid]\").val(datas.baBid);//下拉框赋值\r\n");
      out.write("\t\t\t\t\t\t\t\tform.render(); //重新渲染\r\n");
      out.write("\t\t\t\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t\t\t\tvar msg = result.msg;\r\n");
      out.write("\t\t\t\t\t\t\t\tlayer.msg(msg);\r\n");
      out.write("\t\t\t\t\t\t\t}\r\n");
