 ...
 * Generated at: 2020-02-17 03:06:57 UTC
...
public final class sevenGoods_002dupdate_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t<label class=\"layui-form-label\"><span>*</span>类型 : </label>\r\n");
      out.write("\t\t\t\t\t<div class=\"layui-input-block\">\r\n");
      out.write("\t\t\t\t\t\t<select name=\"gCid\">\r\n");
      out.write("\t\t\t\t\t\t\t<option value=\"\"></option>\r\n");
      out.write("\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"zyc_verify\" data-name=\"g_cid\"></div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t<div class=\"layui-form-item\">\r\n");
      out.write("\t\t\t\t\t<label class=\"layui-form-label\"><span>*</span>名称 : </label>\r\n");
      out.write("\t\t\t\t\t<div class=\"layui-input-block\">\r\n");
      out.write("\t\t\t\t\t\t<input type=\"text\" name=\"gName\" placeholder=\"请输入产品名称\" class=\"layui-input\">\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"zyc_verify\" data-name=\"g_name\"></div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t<div class=\"layui-form-item\">\r\n");
      out.write("\t\t\t\t\t<label class=\"layui-form-label\"><span>*</span>型号 : </label>\r\n");
      out.write("\t\t\t\t\t<div class=\"layui-input-block\">\r\n");
      out.write("\t\t\t\t\t\t<input type=\"text\" name=\"gModel\" placeholder=\"请输入产品型号\" class=\"layui-input\">\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"zyc_verify\" data-name=\"g_model\"></div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t<div class=\"layui-form-item\">\r\n");
      out.write("\t\t\t\t\t<label class=\"layui-form-label\"><span>*</span>归属产品 : </label>\r\n");
      out.write("\t\t\t\t\t<div class=\"layui-input-block\">\r\n");
      out.write("\t\t\t\t\t\t<select name=\"gGid\">\r\n");
      out.write("\t\t\t\t\t\t\t<option value=\"\"></option>\r\n");
      out.write("\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"zyc_verify\" data-name=\"g_gid\"></div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t<div class=\"layui-form-item\">\r\n");
      out.write("\t\t\t\t\t<label class=\"layui-form-label\"><span>*</span>描述 : </label>\r\n");
      out.write("\t\t\t\t\t<div class=\"layui-input-block\">\r\n");
      out.write("\t\t\t\t\t\t<textarea name=\"gDescribe\" placeholder=\"请输入描述\" class=\"layui-textarea\"></textarea>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"zyc_verify\" data-name=\"g_describe\"></div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t'selects': '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/sevenGoods/selectAllCG',//下拉框数据获取\r\n");
      out.write("\t\t\t\t'operate': '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/sevenGoods/updateSevenGoods',//数据提交接口\r\n");
      out.write("\t\t\t\t'value': '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/sevenGoods/selectSevenGoodsById',//编辑时，获取单一数据接口，用以展示编辑数据\r\n");
      out.write("\t\t\t}\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\tvar li = ['<option value=\"\">无</option>'];\r\n");
      out.write("\t\t\t\t\t\t\t\t$(datas).each(function(i){\r\n");
      out.write("\t\t\t\t\t\t\t\t\tli.push('<option value=\"'+datas[i].id+'\">'+datas[i].gName+'</option>');\r\n");
      out.write("\t\t\t\t\t\t\t\t})\r\n");
      out.write("\t\t\t\t\t\t\t\tvar lis = li.join(\"\");\r\n");
      out.write("\t\t\t\t\t\t\t\t$('select[name=gGid]').html(lis);\r\n");
      out.write("\t\t\t\t\t\t\t\tvar types = result.type;\r\n");
      out.write("\t\t\t\t\t\t\t\tvar lin = [];\r\n");
      out.write("\t\t\t\t\t\t\t\t$(types).each(function(i){\r\n");
      out.write("\t\t\t\t\t\t\t\t\tlin.push('<option value=\"'+types[i].id+'\">'+types[i].cName+'</option>');\r\n");
      out.write("\t\t\t\t\t\t\t\t})\r\n");
      out.write("\t\t\t\t\t\t\t\tvar lins = lin.join(\"\");\r\n");
      out.write("\t\t\t\t\t\t\t\t$('select[name=gCid]').html(lins);\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t$(\"select[name=gGid]\").val(datas.gGid);//下拉框赋值\r\n");
      out.write("\t\t\t\t\t\t\t\t$(\"select[name=gCid]\").val(datas.gCid);//下拉框赋值\r\n");
