 ...
 * Generated at: 2020-02-22 02:05:03 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.WEB_002dINF.view.sevenRole;

import javax.servlet.*;
import javax.servlet.http.*;
import javax.servlet.jsp.*;

public final class sevenRole_002dupdate_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t<label class=\"layui-form-label\"><span>*</span>角色名称 : </label>\r\n");
      out.write("\t\t\t\t\t<!-- 输入框或下拉框 -->\r\n");
      out.write("\t\t\t\t\t<div class=\"layui-input-block\">\r\n");
      out.write("\t\t\t\t\t\t<input type=\"text\" name=\"rName\" placeholder=\"请输入角色名称\" class=\"layui-input\">\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<!-- 验证信息展示处，data-name对应验证数据 -->\r\n");
      out.write("\t\t\t\t\t<div class=\"zyc_verify\" data-name=\"r_name\"></div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<!-- 表单XX信息——结束 -->\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t<div class=\"layui-form-item\">\r\n");
      out.write("\t\t\t\t\t<label class=\"layui-form-label\"><span>*</span>角色描述 : </label>\r\n");
      out.write("\t\t\t\t\t<div class=\"layui-input-block\">\r\n");
      out.write("\t\t\t\t\t\t<textarea name=\"rDescribe\" placeholder=\"请输入角色描述\" class=\"layui-textarea\"></textarea>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"zyc_verify\" data-name=\"r_describe\"></div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t<!-- 提交按钮——开始 -->\r\n");
      out.write("\t\t\t\t<div class=\"layui-form-item\">\r\n");
      ...
      out.write("\t\t\t\t\t<div class=\"zyc_verify\" data-name=\"r_permissions\"></div>\r\n");
      out.write("\t\t\t\t</div>\t\r\n");
      out.write("\t\t\t</form>\r\n");
      out.write("\t\t\t<!-- 表单——结束 -->\r\n");
      out.write("\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t'selects': '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/sevenMenus/selectMenus',//菜单权限数据获取\r\n");
      out.write("\t\t\t\t'operate': '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/sevenRole/updateSevenRole',//数据提交接口\r\n");
      out.write("\t\t\t\t'value': '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/sevenRole/selectSevenRoleById',//编辑时，获取单一数据接口，用以展示编辑数据\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\tlayui.use(['form', 'laydate', 'upload', 'tree'], function() {\r\n");
      out.write("\t\t\t\tvar form = layui.form,\r\n");
      out.write("\t\t\t\t\tlaydate = layui.laydate,\r\n");
      out.write("\t\t\t\t\ttree = layui.tree,\r\n");
      ...
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t//为便于展示，进行注销；开发时，请解除注销进行开发\r\n");
      ...
      out.write("\t\t\t\t\t \t\t\ttree.reload('demoId', {//树形图赋值\r\n");
      out.write("\t\t\t\t\t \t\t\t\tdata: result.datas,\r\n");
      out.write("\t\t\t\t\t \t\t\t});\r\n");
      out.write("\t\t\t\t\t \t\t\tform.render();//表单重新渲染\r\n");
      out.write("\t\t\t\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t\t\t\tvar msg = result.msg;\r\n");
      out.write("\t\t\t\t\t \t\t\tlayer.msg(msg);\r\n");
      out.write("\t\t\t\t\t \t\t}\r\n");
      ...
      out.write("\t\t\t\t\tvar checkData = tree.getChecked('demoId');\r\n");
      out.write("\t\t\t\t\tvar permissions = new Array();\r\n");
      out.write("\t\t\t\t\t$(checkData).each(function() {\r\n");
      out.write("\t\t\t\t\t\tpermissions.push(this.id);\r\n");
      out.write("\t\t\t\t\t\tif (this.children) {\r\n");
      ...
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t})\r\n");
      out.write("\t\t\t\t\tdata.field.rPermissions = permissions.join(',');\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t$.ajax({\r\n");
      out.write("\t\t\t\t\t\ttype: \"post\",\r\n");
