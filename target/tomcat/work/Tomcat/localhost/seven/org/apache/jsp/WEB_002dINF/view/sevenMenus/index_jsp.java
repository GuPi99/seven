 ...
 * Generated at: 2020-02-21 01:22:53 UTC
...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t\t<select name=\"mMid\" lay-filter=\"caidan\" lay-search>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"\">全部菜单</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</li>\r\n");
      out.write("\t\t\t\t\t\t<li>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"layui-form-item\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"text\" name=\"mName\" placeholder=\"请输入菜单名称\" autocomplete=\"off\" class=\"layui-input\">\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</li>\r\n");
      ...
      out.write("\t\t\t\t\t<li><button id=\"zyc_add\" class=\"layui-btn layui-btn-normal\"><i class=\"iconfont iconxinzeng\"></i>添加菜单</button></li>\r\n");
      out.write("\t\t\t\t</ul>\r\n");
      ...
      out.write("\t\t</div>\r\n");
      out.write("\t\t<!-- 页面内容——结束 -->\r\n");
      out.write("\t\t<!-- 列表：图标绑定——开始 -->\r\n");
      out.write("\t\t<script type=\"text/html\" id=\"zyc_i\">\r\n");
      out.write("\t\t\t<i class=\"iconfont {{ d.mTag }}\"></i>\r\n");
      out.write("\t\t</script>\r\n");
      out.write("\t\t<!-- 列表：图标绑定——结束 -->\r\n");
      out.write("\t\t<!-- 列表：操作按钮绑定——开始 -->\r\n");
      out.write("\t\t<script type=\"text/html\" id=\"zyc_btn\">\r\n");
      out.write("\t\t\t{{#  if(d.state == '启用'){ }}\r\n");
      out.write("\t\t\t<a class=\"layui-btn layui-btn-xs layui-btn-warm\" title=\"禁用\" href=\"#\" lay-event=\"state\">禁用</a>\r\n");
      out.write("\t\t\t{{#  } }}\r\n");
      out.write("\t\t\t{{#  if(d.state == '禁用'){ }}\r\n");
      out.write("\t\t\t<a class=\"layui-btn layui-btn-xs layui-btn-warm\" title=\"启用\" href=\"#\" lay-event=\"state\">启用</a>\r\n");
      out.write("\t\t\t{{#  } }}\r\n");
      ...
      out.write("\t\t<script src=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/static/js/menu/load.js\"></script>\r\n");
      out.write("\t\t<script>\r\n");
      out.write("\t\t\tvar SCOPE = {\r\n");
      out.write("\t\t\t\t'table_url': '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/sevenMenus/getSevenMenusList', //列表数据查询来源（json文件或接口地址，可自行修改）；模糊搜索查询接口地址（menu指当前控制器，selects指查询方法，可自行修改）\r\n");
      out.write("\t\t\t\t'selects': '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/sevenMenus/selectAll',                 //模糊搜索下拉框数据方法接口\r\n");
      out.write("\t\t\t\t'add_url': '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/sevenMenus/toAdd',//新增页面跳转路径（menu指当前控制器，add指页面或控制器方法，可自行修改）\r\n");
      out.write("\t\t\t\t'edit_url': '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/sevenMenus/toUpdate',//修改页面跳转路径（menu指当前控制器，add指页面或控制器方法，可自行修改）\r\n");
      out.write("\t\t\t\t'operate': '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/sevenMenus/updateState',                //数据操作方法，如需增加多个方法，可在load.js中进行修改\r\n");
      out.write("\t\t\t\t'cancel': '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/sevenMenus/deleteSevenMenus',                  //数据删除方法接口\r\n");
      out.write("\t\t\t}\r\n");
