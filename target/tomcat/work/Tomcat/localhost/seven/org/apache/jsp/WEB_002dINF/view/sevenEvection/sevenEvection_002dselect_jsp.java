 ...
 * Generated at: 2020-02-27 09:29:23 UTC
...
public final class sevenEvection_002dselect_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/sevenTripReport/index\">出差报告</li>\r\n");
      out.write("\t\t\t\t\t\t</ul>\r\n");
      ...
      out.write("\t\t\t\t\t\t<input type=\"hidden\" name=\"eState\" />\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t</form>\r\n");
      out.write("\t\t\t<!-- 表单——结束 -->\r\n");
      ...
      out.write("\t\t\t\t'value' :  '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/sevenEvection/selectSevenEvection'\r\n");
      out.write("\t\t\t}\r\n");
      ...
      out.write("\t\t\t\t\t\t$('.zyc_iframe').attr('src', $('.layui-tab-title>.layui-this').data('url') + '?id=' + id);\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\tvar state = $('input[name=eState]').val();\r\n");
      out.write("\t\t\t\t\t\t\t\tif(state != '' && state > 0){\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t$('#know').css('display','none');\r\n");
      out.write("\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\t$('.zyc_iframe').attr('src', $('.layui-tab-title>.layui-this').data('url') + '?id=' + id + '&state=' + state);\r\n");
      out.write("\t\t\t\t\t\t\t\telement.on('tab(demo)', function(data) {\r\n");
      out.write("\t\t\t\t\t\t\t\t\t$('.zyc_iframe').attr('src', $(this).data('url') + '?id=' + id + '&state=' + state);\r\n");
      out.write("\t\t\t\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t\t\t\t} else {\r\n");
