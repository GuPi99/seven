 ...
 * Generated at: 2020-03-10 06:22:21 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.WEB_002dINF.view.sevenAccount;

import javax.servlet.*;
import javax.servlet.http.*;
import javax.servlet.jsp.*;

public final class sevenAccount_002dadd_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t<link rel=\"shortcut icon\" href=\"__STATIC__/img/favicon.ico\" />\r\n");
      ...
      out.write("\t\t\t\t\t<!-- *表示必填，非必填项可将span标签删除 -->\r\n");
      out.write("\t\t\t\t\t<label class=\"layui-form-label\"><span>*</span>账户名称 : </label>\r\n");
      out.write("\t\t\t\t\t<!-- 输入框或下拉框 -->\r\n");
      out.write("\t\t\t\t\t<div class=\"layui-input-block\">\r\n");
      out.write("\t\t\t\t\t\t<input type=\"text\" name=\"aAccount\" placeholder=\"请输入账户名称\" id=\"aAccount\" onblur=\"checkName()\" class=\"layui-input\">\r\n");
      out.write("\t\t\t\t\t\t<span id=\"remind\" color=\"red\"></span>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<!-- 验证信息展示处，data-name对应验证数据 -->\r\n");
      out.write("\t\t\t\t\t<div class=\"zyc_verify\" data-name=\"aAccount\"></div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<!-- 表单XX信息——结束 -->\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t<div class=\"layui-form-item\">\r\n");
      out.write("\t\t\t\t\t<label class=\"layui-form-label\"><span>*</span>密码 : </label>\r\n");
      out.write("\t\t\t\t\t<div class=\"layui-input-block\">\r\n");
      out.write("\t\t\t\t\t\t<input type=\"password\" name=\"aPassword\" placeholder=\"请输入密码\" class=\"layui-input\">\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"zyc_verify\" data-name=\"aPassword\"></div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class=\"layui-form-item\">\r\n");
      out.write("\t\t\t\t\t<label class=\"layui-form-label\"><span>*</span>角色 : </label>\r\n");
      out.write("\t\t\t\t\t<div class=\"layui-input-block\">\r\n");
      out.write("\t\t\t\t\t\t<select name=\"aRid\">\r\n");
      out.write("\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"zyc_verify\" data-name=\"aRid\"></div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<div class=\"layui-form-item\">\r\n");
      out.write("\t\t\t\t\t<label class=\"layui-form-label\"><span>*</span>使用员工: </label>\r\n");
      out.write("\t\t\t\t\t<div class=\"layui-input-block\">\r\n");
      out.write("\t\t\t\t\t\t<select name=\"aSid\">\r\n");
      out.write("\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"zyc_verify\" data-name=\"aSid\"></div>\r\n");
      out.write("\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t<!-- 提交按钮——开始 -->\r\n");
      out.write("\t\t\t\t<div class=\"layui-form-item\">\r\n");
      out.write("\t\t\t\t\t<div class=\"layui-input-block\">\r\n");
      out.write("\t\t\t\t\t\t<input type=\"hidden\" name=\"id\" />\r\n");
      out.write("\t\t\t\t\t\t<button lay-filter=\"formDemo\" lay-submit class=\"layui-btn\" id=\"commit\">立即提交</button>\r\n");
      ...
      out.write("\t\t\t\t'selects': '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/sevenRole/selectAllRole',//角色数据获取\r\n");
      out.write("\t\t\t\t'operate': '");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/sevenAccount/addSevenAccount',//数据提交接口\r\n");
      out.write("\t\t\t}\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\tli.push('<option value=\"'+datas[i].id+'\">'+datas[i].rName+'</option>');\r\n");
      out.write("\t\t\t\t\t\t\t\t})\r\n");
      out.write("\t\t\t\t\t\t\t\tvar lis = li.join(\"\");\r\n");
      out.write("\t\t\t\t\t\t\t\t$('select[name=aRid]').html(lis);\r\n");
      out.write("\t\t\t\t\t\t\t\tvar datan = result.datan;\r\n");
      out.write("\t\t\t\t\t\t\t\tvar lin = [];\r\n");
      out.write("\t\t\t\t\t\t\t\t$(datan).each(function(i){\r\n");
      out.write("\t\t\t\t\t\t\t\t\tlin.push('<option value=\"'+datan[i].id+'\">'+datan[i].sName+'</option>');\r\n");
      out.write("\t\t\t\t\t\t\t\t})\r\n");
      out.write("\t\t\t\t\t\t\t\tvar lins = lin.join(\"\");\r\n");
      out.write("\t\t\t\t\t\t\t\t$('select[name=aSid]').html(lins);\r\n");
      ...
      out.write("\t\t\t\t        url: \"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null, false));
      out.write("/sevenAccount/checkName\",\r\n");
      out.write("\t\t\t\t        data:{\"aAccount\":aAccount},\r\n");
      out.write("\t\t\t\t        dataType:\"json\",\r\n");
      out.write("\t\t\t\t        success: function(msg){\r\n");
      out.write("\t\t\t\t        \tif (msg.status==\"error\") {\r\n");
      out.write("\t\t\t\t        \t\tdocument.getElementById(\"commit\").disabled=true;\r\n");
      out.write("\t\t\t\t                $(\"#remind\").html(\"<font color='red'>用户名已存在，请更换！</font>\");\r\n");
      out.write("\t\t\t\t            }else if(msg.status==\"success\"){\r\n");
      out.write("\t\t\t\t                $(\"#remind\").html(\"\")\r\n");
      out.write("\t\t\t\t            }\r\n");
      out.write("\t\t\t\t        }\r\n");
      out.write("\t\t\t\t    });\r\n");
      out.write("\t\t\t}\r\n");
